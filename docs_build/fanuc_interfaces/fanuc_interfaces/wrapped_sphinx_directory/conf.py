...
exec(open("/home/ella/ros2_ws/docs_build/fanuc_interfaces/fanuc_interfaces/default_sphinx_project/conf.py").read())
...
ensure_global('project', "fanuc_interfaces")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rosidl_default_runtime', 'action_msgs']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/ella/ros2_ws/docs_build/fanuc_interfaces/fanuc_interfaces/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        ...
        'msg_publishers': ('http://docs.ros.org/en/latest/p/msg_publishers/', '/home/ella/ros2_ws/cross_reference/msg_publishers/objects.inv'),
