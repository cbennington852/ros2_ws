...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ella/ros2_ws/fanuc_ros2_drivers/src/action_servers/action_servers', '..')))
...
copyright = 'The <action_servers> Contributors. License: TODO: License declaration'
author = """Kris Olds"""
