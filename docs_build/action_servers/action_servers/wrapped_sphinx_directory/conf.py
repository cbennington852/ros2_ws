...
exec(open("/home/ella/ros2_ws/docs_build/action_servers/action_servers/default_sphinx_project/conf.py").read())
...
ensure_global('project', "action_servers")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['fanuc_interfaces', 'rclpy', 'std_msgs']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/ella/ros2_ws/docs_build/action_servers/action_servers/wrapped_sphinx_directory/generated",
