...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ella/ros2_ws/fanuc_ros2_drivers/src/srv_services/srv_services', '..')))


# -- Project information -----------------------------------------------------

project = 'srv_services'
# TODO(tfoote) The docs say year and author but we have this and it seems more relevant.
copyright = 'The <srv_services> Contributors. License: Apache-2.0'
author = """Kris Olds"""
