...
exec(open("/home/ella/ros2_ws/docs_build/msg_publishers/msg_publishers/default_sphinx_project/conf.py").read())
...
ensure_global('project', "msg_publishers")
ensure_global('author', """Kris Olds""")
ensure_global('release', "0.1.1")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['python3-pycomm3', 'fanuc_interfaces', 'rclpy', 'std_msgs']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/ella/ros2_ws/docs_build/msg_publishers/msg_publishers/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        'action_servers': ('http://docs.ros.org/en/latest/p/action_servers/', '/home/ella/ros2_ws/cross_reference/action_servers/objects.inv'),
        'fanuc_interfaces': ('http://docs.ros.org/en/latest/p/fanuc_interfaces/', '/home/ella/ros2_ws/cross_reference/fanuc_interfaces/objects.inv'),
        'srv_services': ('http://docs.ros.org/en/latest/p/srv_services/', '/home/ella/ros2_ws/cross_reference/srv_services/objects.inv')
    })
