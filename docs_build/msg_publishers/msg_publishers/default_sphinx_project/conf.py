...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ella/ros2_ws/fanuc_ros2_drivers/src/msg_publishers/msg_publishers', '..')))


# -- Project information -----------------------------------------------------

project = 'msg_publishers'
# TODO(tfoote) The docs say year and author but we have this and it seems more relevant.
copyright = 'The <msg_publishers> Contributors. License: TODO: License declaration'
author = """Kris Olds"""
